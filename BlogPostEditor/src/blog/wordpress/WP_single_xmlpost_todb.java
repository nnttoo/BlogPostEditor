...
public class WP_single_xmlpost_todb extends WP_xmlparse{  
	...
	public void postTodb(PostDb dbpost, HttpResponse xmlresponse,JSObject callback, postDBContent dbcontent){ 
		try{
		Node workingnode = nodefromHttpResonse(xmlresponse);
		
		FindBynext finder = new FindBynext(workingnode);
		String parentNodename =  "value";
